...
User.create(image_name: File.open("#{Rails.root}/public/uploads/user/image_name/1/syuu.jpg"), name: "愁syuu", email: "resort1315@gmail.com", password: "kyou0216")
User.create(image_name: File.open("#{Rails.root}/public/uploads/user/image_name/10/mars.jpg"), name: "マーズギャ", email: "mars@gmail.com", password: "mars1234")
